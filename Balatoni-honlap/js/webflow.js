...
Webflow.require('ix').init([
  ...
  {"slug":"hover-play-icon","name":"Hover play icon","value":{"style":{"opacity":0,"x":"0px","y":"50px","z":"0px"},"triggers":[{"type":"hover","selector":".play-button","preserve3d":true,"stepsA":[{"transition":"transform 450ms ease-in-out-back 0","x":"0px","y":"-50%","z":"0px","scaleX":1.1,"scaleY":1.1,"scaleZ":1}],"stepsB":[{"transition":"transform 250ms ease 0","x":"0px","y":"-50%","z":"0px","scaleX":1,"scaleY":1,"scaleZ":1}]},{"type":"scroll","stepsA":[{"opacity":1,"transition":"transform 1500ms ease 0, opacity 1500ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}}
]);
